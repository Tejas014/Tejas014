      ...
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <div class="title-tag mb-lg-5 mb-md-4 mb-sm-4 mb-3 pb-lg-3 pb-md-2">
          ...
          <div class="sub-title-mid text-center mb-lg-4 mb-3">
            <h2>VIEW MY COMPLAINT</h2>
          </div>
         <?php 
		$a= $_SESSION['uname'];
		 include("config.php");
				$result = mysqli_query($db,"SELECT * FROM complaint where Added='$a'")or die(mysqli_error());
        ...
        <div class="row">
          ...
          <div class="col-lg-6 left-abut-txt ">
            ...
            <div class="read-buttn ">
              <a href="delmycmp.php?id=<?php echo $row['Cid'];?>" class=" scroll">Delete</a>
            </div>
