...
<div style="width:40%;float:left;margin:0;">
			<img src="./images/rigester.jpg" style="width:100%;height:700px;"/>
        </div>
				...
				<table class="style1">
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:black;">Register Here !!!</span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="style2">
                            &nbsp;</td>
                        <td align="right">
                            <span style="font-size:20px;font-weight:bold;">Name: </span></td>
                        <td>&nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                        &nbsp;
                        <input type="password"  id="pswd" name="pswd" required style="display: inline-block;border: 1px solid #ccc;border-radius: 2px;" />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <input id="logi" type="submit" value="Register"style="height:35px;background-color:#d5ec57;border-radius:5px;width:150px;" onclick="return validator();" /></td>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
