...
<html lang="zxx">
  ...
  <body>
    <div class="header-outs1" id="header">
        ...
        <div class="container-fluid">
          <nav>
            ...
            <ul class="menu mt-lg-3 mt-2">
              ...
              <li ><a href="addpresident.php">Add President</a></li>
              <li><a href="maintainpresident.php">Maintain President</a></li>
              <li><a href="addposter.php">Add Poster</a></li>
              <li ><a href="maintainposter.php">Maintain Poster</a></li>
