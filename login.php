				...
				<table class="style1">
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:black;">Enter Admin And Prisident Account !!!</span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="style2">
                            &nbsp;</td>
                        <td align="center" colspan="2">
                            <a href="forgot.php"style="font-weight:bolder;font-size:25px;color:black;">Forgot Password</a></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                </table>
