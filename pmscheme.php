...
<div style="width:100%;float:left;padding-left:15px;padding-top:10px;min-height:550px;>
            ...
            <div style="width:50%;float:left;padding-left:1px;">
				...
				<h1 style="font-weight:bolder;font-size:25px;color:red;text-align:center;">  Manage the Schemes !!!</h1> <br><br>
				<?php
...
$result = mysqli_query($db,"SELECT * FROM schemes")or die(mysqli_error());

echo "<table border='1' cellpadding='10' width='1200px'>";
echo "<tr style='text-decoration:underline;text-align:center;'>
<th><font color='#ffff00'>Scheme ID</font></th>
<th><font color='#ffff00'>Scheme Name</font></th>
...
echo '<td><b><font color="#663300">' . $row['sid'] . '</font></b></td>';
...
echo '<td><b><font color="#ffff00"><a href="deletescheme.php?id=' . $row['sid'] . '">Delete</a></font></b></td>';
